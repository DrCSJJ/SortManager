...
public class DisplayLoader {
    ...
    private static void printQuestionArraySize() {
        System.out.println("Pleas Select the array Length (Max 1000 Min 1) ");
    }

    private static void printQuestionWhichSort() {
        ...
        System.out.println("4: for InsertSorter");
        System.out.println("5: for QuickSorter");
    }
}
