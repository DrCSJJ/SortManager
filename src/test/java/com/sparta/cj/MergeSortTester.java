...
public class MergeSortTester {
    ...
    void CheckThatThisBackwardsArrayIsSorted() {
        Assertions.assertArrayEquals((new int[]{1, 2, 3, 4, 5, 6}), (MergeSort.mergeSortSplit(new int[]{6, 5, 4, 3, 2, 1})));
    }

    @Test
    @DisplayName("Check that this Sorted Array remains the same")
    void CheckThatThisSortedArrayRemainsTheSame() {
        Assertions.assertArrayEquals((new int[]{1, 2, 3, 4, 5, 6}), (MergeSort.mergeSortSplit(new int[]{1, 2, 3, 4, 5, 6})));
    }

    @Test
    @DisplayName("Check that this blank array does not break my code")
    void CheckThatThisBlankArrayDoesNotBreakCode() {
        Assertions.assertArrayEquals((new int[]{}), (MergeSort.mergeSortSplit(new int[]{})));
    }
    @Test
    ...
    void CheckThatThisSingleNumberArrayDoesNotBreakCode() {
        Assertions.assertArrayEquals((new int[]{1}), (MergeSort.mergeSortSplit(new int[]{1})));
    }
